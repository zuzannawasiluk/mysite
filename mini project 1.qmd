...
bikeshare <- read_csv("Bikeshare_Scooter_Systems_20240919.csv") |>  
  rename(state = STATE, city = CITY, citystate = CITYSTATE) |>  
...
### Static Map with Numerical Variable
...
obesity_data |>
  ...
  labs(
    title = "Percent of Adults Aged 18 years and Older who are Obese,
    State-Level",
...
Description: This plot describes the percentage of adults who are obese by state as opposed to total population. Generally, most of the states were either magenta or dark purple indicating that they fall between 15-20. Therefore, their percentage of the adult population who have obesity was on the lower half of the scale. There is a concerning pattern of orange and yellow shades in the South region, representing a higher percentage of obese adults in this area than in the rest of the United States. Furthermore, the lightest states are all next to each other which prompts more elaborate investigation into why AR, MS, and AL have such an alarming trend of adult obesity.<br>

The link to the website where I found this data can be found here:[U.S. Department of Health & Human Services](https://catalog.data.gov/dataset/nutrition-physical-activity-and-obesity-behavioral-risk-factor-surveillance-system).<br>
...
### Static Map with Categorical Variable
...
### Interactive Choropleth Map for Obesity Data (Numerical)
...
### Interactive Chloropleth Map for Bikeshare Data (Categorical)
